...
// ambientLight.color = new THREE.Color(0xfffffff)
// ambientLight.intensity = 0.2
// scene.add(ambientLight)

// const directionalLight = new THREE.DirectionalLight()
// directionalLight.color = new THREE.Color(0xfffffff)
// directionalLight.intensity = 1.0
// scene.add(directionalLight)

// const hemisphereLight = new THREE.HemisphereLight()
// hemisphereLight.color = new THREE.Color('red')
// hemisphereLight.groundColor = new THREE.Color('blue')
...
// rectAreaLight.color = new THREE.Color(0xffffff)
